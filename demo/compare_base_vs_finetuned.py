...
# Add the API src directory to Python path for imports
...
def main():
    ...
    print(f"{'='*80}")
    print("\n  Good test terms that work well with this model:")
    print("  • Abbreviations: u, jk, ngl, irl, idc, asap, ez, idk, ty, plz")
    print("  • Slang: stan, sis, lmao, nsfw, ootd, ppl, sry")
    print(f"\n{'='*80}\n")
